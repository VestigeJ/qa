...
#
PATH=/usr/local/sbin:/usr/local/bin:/usr/local/:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/go/bin:/snap/bin:/var/lib/rancher/k3s/bin:/var/lib/rancher/rke2/bin:/usr/local/bin/go/bin:/opt/rke2/bin/:${HOME}/.krew/bin
